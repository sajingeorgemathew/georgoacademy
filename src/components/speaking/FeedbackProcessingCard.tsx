...
// Waiting state shown while the server transcribes and scores an
// attempt. Pure presentational component, so both the recording flow
// and the result page can render it.
export function FeedbackProcessingCard() {
  return (
    <section
      role="status"
      aria-live="polite"
