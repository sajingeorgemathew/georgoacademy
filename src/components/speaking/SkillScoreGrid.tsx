...
// Category breakdown for the four scoring areas. Cards stack in one
// column on mobile and sit two across on larger screens.
export function SkillScoreGrid({ skills }: { skills: SkillScore[] }) {
  return (
    <section
      aria-label={resultCopy.skillBreakdownHeading}
    ...
    >
      <h2 className="font-serif text-xl font-semibold tracking-tight text-ink">
        {resultCopy.skillBreakdownHeading}
      </h2>
