...
Build Mock Test 1 Reading Part 3 prototype.
...
This ticket should build only the Reading Part 3 question experience.

Do not build Reading Part 3 review or score in this ticket.
...
Do not change Reading Part 1 or Part 2 unless safely improving shared Reading components.
...
Do not invent information sections.
...
This is an internal prototype route for Reading Part 3.

Do not add a full Reading test card yet.
Do not disturb the existing Listening card or Reading Part 1 and Part 2 routes.

## Expected Reading Part 3 structure

Reading Part 3 is usually an information-matching task, but the source document is the authority.

The prototype should support only what the source contains:

- intro screen
- reading information or passage screen
- question panel
- multiple-choice or matching-style questions
- local answer state
...
Keep Reading Part 1 and Part 2 internal preview links.
...
2. Reading Part 3 task screen

Shows:

- passage, information sections, or article content from the source
...
Use the existing Reading timer pattern from Part 1 and Part 2 if appropriate.
...
Use the same answer map shape already used by Reading Part 1 and Part 2:
...
If the source document includes a Reading Part 3 answer key, store it in the content object, but do not expose it to the client question screen.

If there is no answer key in the source document, document that clearly.

Do not build score or review yet.

The next ticket should handle Reading Part 3 review and score securely.

## Visual requirements

Reading Part 3 should feel consistent with the completed exam mode:
...
- internal scroll only inside passage, information, or question areas
...
- paragraph or section labels should be clear
...
- no Reading Part 3 review screen
- no Reading Part 3 score screen
...
- Reading Part 3 route exists
- Reading Part 3 content is centralized
- Reading Part 3 source content is used
- Passage, article, or information area displays
- Questions display
...
- Dashboard has internal Reading Part 3 preview access
- No Reading Part 3 review is built
- No Reading Part 3 score is built
...
- Existing Reading Part 1 and Part 2 routes still work
- Existing Speaking and Writing AI flows are untouched
- docs/product/reading-part-3-prototype.md exists
- npm run lint passes
