# EXAM-10 - Listening Part 4 Answer Review and Score Screen

## Goal

Add the answer review and score screen for Mock Test 1 Listening Part 4.

This ticket completes the local prototype cycle for Listening Part 4 only.
...
Use the existing Listening Part 4 content object:

src/features/exam-engine/mock-tests/mock-test-1/listening-part-4.ts

The confirmed Listening Part 4 answer key is already stored there.
...
Confirmed option IDs:

- q1: listening-part-4-q1-d
- q2: listening-part-4-q2-b
- q3: listening-part-4-q3-a
- q4: listening-part-4-q4-c
- q5: listening-part-4-q5-b

If this answer key is already stored from EXAM-09, reuse it.
...
At the end of the dropdown question screen, after all 5 answers are selected, the user should go to:

1. Answer review screen
2. Score screen
3. End of Listening Part 4 screen
...
If existing review components assume radio question structure only, carefully extend or adapt them to support dropdown completion questions without breaking Listening Parts 1, 2, and 3.
...
Confirm the answerKey array in Listening Part 4 has all 5 correctOptionId values.

Correct answers:

- q1: tearing up a $20 bill.
- q2: took a picture of her $20 bill.
- q3: had different numbers.
- q4: a school project.
- q5: stole money from his audience.

Important:

- match by exact option text first
- if punctuation differs, map to the closest existing option text
- do not display the answer key on the dropdown question screen
...
- title: Listening Part 4 Answer Review
- subtitle: Review your answers before viewing the score.
- question number
- completion statement or short question label
- student selected answer
- correct answer
- status: correct, incorrect, or unanswered
- button: View score
- Back button to return to the dropdown question screen for prototype testing
...
- title: End of Listening Part 4
- message: You have completed Listening Part 4 of Mock Test 1.
- button: Back to dashboard
- optional button: Restart Listening Part 4
- optional placeholder: Listening Part 5 will be added in the next ticket.

Do not build Part 5 in this ticket.

## Local state requirements

Use local client-side state from EXAM-09.
...
- Answer review screen works for Listening Part 4
- Score screen works for Listening Part 4
- End of Listening Part 4 screen works
- Review table shows all 5 dropdown questions
