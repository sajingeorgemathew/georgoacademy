# EXAM-07 - Listening Part 3 Prototype

## Goal

Build Mock Test 1 Listening Part 3 prototype.

This ticket should implement Listening Part 3: Listening for Information.
...
Do not build the Part 3 answer review screen.
Do not build the Part 3 score screen.
...
Use Mock Test 1 Listening Part 3 from:

mock-tests/mock-test-1/Mock Test 1 -Sajinlinks.docx

or the extracted documentation created in EXAM-00.

Listening Part 3 details:

- Section name: Listening for Information
- Scenario: conversation between a man and a woman who work at a university
- The man is the woman's supervisor and has stopped to speak to her
- One conversation audio file
- Six question audio files
- Six questions total
...
## Confirmed Part 3 answer key

The user provided the confirmed answer key from the Part 3 answer screenshot.
...
- Part 3 review and score will be built in the next ticket.
...
This route should render Listening Part 3 prototype.
...
- Instructions
- You will hear a conversation between a man and a woman who work at a university.
- The man, who is the woman's supervisor, has stopped to speak to the woman.
- Next button
...
- audio player for Part 3 conversation
- Next button
...
The question screen should match the Listening Part 1 and Part 2 prototype style:
...
- Part 3 answer review is not built
...
- Listening Part 3 prototype route exists
- Listening Part 3 content is typed and centralized
- university workplace scenario appears
- conversation audio is represented
- 6 question screens are represented
...
- Part 3 answer key is stored but not shown on question screens
...
- docs/product/listening-part-3-prototype.md exists
- npm run lint passes
