...
Add secure answer marking, review, and score for Mock Test 1 Reading Part 3.

This continues EXAM-20.

EXAM-20 created the Reading Part 3 prototype at:
...
- score screen
- score out of the Reading Part 3 question count
- answered count
- blank count
...
Use existing Reading Part 3 content from:
...
Do not invent or change information section text.
Do not invent or change paragraph labels.
...
Important:
If these helpers already exist from EXAM-17 and EXAM-19, reuse and extend them. Do not duplicate Part 3-only logic.

Create Part 3-specific screen components only if existing shared components cannot be reused cleanly:
...
Implement a server action similar to Reading Part 1 and Reading Part 2.

Suggested name:

markReadingPartThree
...
If needed, improve the shared Reading stripping function so it supports Reading Part 1, Part 2, and Part 3.

The client question screen should only receive:

- passage, information sections, article text, or task content
- questions
- options
- timing information
- labels and copy
...
After the user completes Reading Part 3, allow them to view review.

The review screen should show:

- score summary
- all Reading Part 3 questions
- selected answer
- correct answer
...
- correct out of total Reading Part 3 questions
- percentage
- answered count
- blank count
- clear note that this is practice only
- button to review answers
- button to restart Reading Part 3
...
Current EXAM-20 flow:

1. intro
2. passage, article, or information with questions
3. completion
...
Example:
If Part 3 has 9 questions and the user answers 6:
...
Use the actual Reading Part 3 question count from the source content.

## Visual requirements

Use the same neutral exam style from completed Reading and Listening work:
...
Keep the internal Reading prototype dashboard buttons from EXAM-18 and EXAM-20.
...
- Reading Part 3 route still loads
- User can select answers
- User can finish Reading Part 3 with blanks
- Server action marks answers
- Score screen appears
- Score shows correct out of total Reading Part 3 questions
- Percentage appears
- Blank answers count as incorrect
- Review screen shows all Reading Part 3 questions
...
- Reading Part 2 route still works
- Listening route still works
- Dashboard internal Reading links still work
- No Reading Part 4 is built
...
- docs/product/reading-part-3-review-score.md exists
- npm run lint passes
