...
Add secure answer marking, review, and score for Mock Test 1 Reading Part 4.

This continues EXAM-22.

EXAM-22 created the Reading Part 4 prototype at:
...
- score screen
- score out of the Reading Part 4 question count
- answered count
- blank count
...
Use existing Reading Part 4 content from:
...
Do not invent or change viewpoint text.
Do not invent or change question text.
...
Important:
If these helpers already exist from EXAM-17, EXAM-19, and EXAM-21, reuse and extend them. Do not duplicate Part 4-only logic unless the source format requires a small adapter.

Create Part 4-specific screen components only if existing shared components cannot be reused cleanly:
...
Implement a server action similar to Reading Parts 1, 2, and 3.
...
If needed, improve the shared Reading stripping function so it supports Reading Parts 1-4.

The client question screen should only receive:

- passage, viewpoint, article, or task content
- questions
- options
- timing information
- labels and copy
...
After the user completes Reading Part 4, allow them to view review.

The review screen should show:

- score summary
- all Reading Part 4 questions
- selected answer
- correct answer
...
- Reading Part 4 score
- correct out of total Reading Part 4 questions
- percentage
- answered count
- blank count
- clear note that this is practice only
- button to review answers
- button to restart Reading Part 4
...
Current EXAM-22 flow:

1. intro
2. passage, viewpoint, article, or information with questions
3. completion
...
Use the actual Reading Part 4 question count from the source content.
...
Keep the internal Reading prototype dashboard buttons from EXAM-18, EXAM-20, and EXAM-22.
...
- Reading Part 4 route still loads
- User can select answers
- User can finish Reading Part 4 with blanks
- Server action marks answers
- Score screen appears
- Score shows correct out of total Reading Part 4 questions
- Percentage appears
- Blank answers count as incorrect
- Review screen shows all Reading Part 4 questions
...
- Reading Part 3 route still works
...
- docs/product/reading-part-4-review-score.md exists
- npm run lint passes
